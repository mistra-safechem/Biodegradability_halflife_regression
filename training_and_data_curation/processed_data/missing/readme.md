...
- imported this csv manually to EXCEL from where manual curation was/is done (expert understanding or manufacturer lookup esp the "PCBs"). Ambigous namings or not found compounds remaind as N/A. NOTE: the pubchem retrieval was never implemented, this might have been able to resolve more of these compounds, e.g. the PCB ones.
