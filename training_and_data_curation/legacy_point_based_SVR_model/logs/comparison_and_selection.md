...
Date: 2026-04-21
Pipelines compared:
- **Interval-aware SVR** — `WP3bioddeg_V2/logs/log_summary_presentation.md`
- **Plain regression SVR** — `WP3bioddeg_V2/legacy_point_based_SVR_model/logs/log_summary_presentation.md`
